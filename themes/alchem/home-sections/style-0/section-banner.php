<?php 
 ...
 $youtube_mute = 'false';
  ...
  if( $content_model == 3 )
   $section_class .= ' alchem-youtube-section verticalmiddle';
...
<?php elseif( $content_model == 2 ):?>
	...
	?>
          <div class="item">
            <section  class="section magee-section section-banner verticalmiddle page-title-bar <?php echo 'alchem_section_0_image_'.$i;?>" style="background-image: url(<?php echo $image;?>);background-repeat:repeat;">
              <div class="section-content">
                <div class="container">
                  ...
                  <p style="text-align:right;font-size: 36px;" class="<?php echo 'alchem_section_0_sub_title_'.$i;?>"><?php echo do_shortcode($sub_title);?></p>
