	...
	if( has_post_thumbnail()  ){
		...
		$featured_image = '<div class="feature-img-box"><div class="img-box figcaption-middle text-center from-top fade-in">
                                                                <a href="'.get_permalink().'">
                                                                    <img src="'.$image_attributes[0].'" alt="" class="feature-img" style="width:100%;height:200px;">
      ...
      $featured_image ='<div class="feature-img-box"><div class="img-box figcaption-middle text-center from-top fade-in">
                                                                <a href="'.get_permalink().'">
                                                                    <img src="'.get_template_directory_uri().'/images/timg.jpg" alt="" class="feature-img" style="width:100%;height:auto;">
                                                                    <div class="img-overlay dark">
                                                                        <div class="img-overlay-container">
                                                                            <div class="img-overlay-content">
                                                                                <i class="fa fa-link"></i>
                                                    ...
                                                    <article class="entry-box">
                                                        ...
                                                        <div class="entry-main">
                                                            ...
                                                            <div class="entry-summary">
                                                                '.alchem_get_summary().'
                                                                <br/>
                                                                <a class="btn-normal pull-right" href="'. get_permalink() .'">查看更多</a>
                                                            </div>
                                                        </div>
                                                    </article>
                                                </div>
