	...
	jQuery.mbYTPlayer = {
		...
		getDataFromAPI: function( YTPlayer ) {
			...
			if( YTPlayer.videoData ) {
				...
				jQuery.getJSON( jQuery.mbYTPlayer.locationProtocol + "//www.useso.com/youtube/v3/videos?id=" + YTPlayer.videoID + "&key=" + jQuery.mbYTPlayer.apiKey + "&part=snippet", function( data ) {
					YTPlayer.dataReceived = true;
					jQuery( YTPlayer ).trigger( "YTPChanged" );
